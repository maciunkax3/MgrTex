...
__kernel void flops_float1(__global float *ptr, float _A)
{
    float x = _A;
...
__kernel void flops_float2(__global float *ptr, float _A)
{
...
__kernel void flops_float4(__global float *ptr, float _A)
{
...
__kernel void flops_float8(__global float *ptr, float _A)
{
...
__kernel void flops_float16(__global float *ptr, float _A)
{
